...
function handleWaterChapter2Choice(choice) {
    switch (choice) {
        case 1:
            ...
            updateSkillWithDifficulty('leadership', 3); // Public decision-making
            updateSkillWithDifficulty('diplomacy', 2); // Managing community response
        ...
        case 2:
            ...
            updateSkillWithDifficulty('stealth', 3); // Active concealment
            updateSkillWithDifficulty('empathy', 2); // Protecting others' safety
            if (skillCheck('wisdom', 16)) {
                ...
                updateSkillWithDifficulty('leadership', -2); // Loss of control
            }
            break;
        case 3:
            ...
            updateSkillWithDifficulty('combat', 2); // Testing abilities
            updateSkillWithDifficulty('wisdom', 1); // Assessing truth
            if (skillCheck('empathy', 12)) {
                ...
                updateSkillWithDifficulty('leadership', -1); // Undermining authority
            }
            break;
        case 4:
            ...
            updateSkillWithDifficulty('empathy', 2); // Understanding legacy
    ...
    setTimeout(() => {
        updateChoices([
          { text: "Continue", action: () => { startWaterChapter3(); playVideo('waterCutscene3.mp4'); } }
        ]);
    }, 300);
