...
function handleOpt1AirChapter13Choice(choice) {
    ...
    setTimeout(() => {
        updateChoices([{ text: "Continue", action: () => { startAirChapter14(); playVideo('airCutscene14.mp4'); } }]); // Option to continue after reading
    }, 300);
}
    ...
    switch (choice) {
        case 1:
            ...
            if (skillCheck('leadership', 10)) {
                updateReputationWithDifficulty('airNomads', -10); // A difficult decision that might tarnish your reputation
                ...
                updateReputationWithDifficulty('airNomads', -20); // Failure to lead effectively
        ...
        case 2:
            ...
            if (skillCheck('wisdom', 14)) {
                updateReputationWithDifficulty('airNomads', 10); // Successfully leading a large-scale retreat boosts your reputation
                ...
                updateReputationWithDifficulty('airNomads', -5); // The plan's failure leads to negative consequences
            ...
            case 3:
                ...
                if (gameState.allies.includes('Toph') || skillCheck('combat', 12)) {
                    updateReputationWithDifficulty('airNomads', 5); // Successfully using bending to protect the army enhances your reputation
                    ...
                    updateReputationWithDifficulty('airNomads', -10); // Failure to effectively use bending skills results in negative outcomes
        ...
        case 4:
            ...
            if (skillCheck('stealth', 13)) {
                updateReputationWithDifficulty('airNomads', 5); // Successfully delaying enemy forces boosts your reputation
                ...
                updateReputationWithDifficulty('airNomads', -5); // A failed trap can lead to dire consequences
