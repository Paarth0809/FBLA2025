    ...
    switch (choice) {
        case 1:
            ...
            if (skillCheck('wisdom', 10)) {
                updateHealthWithDifficulty(5);  // Successful introspection improves mental resilience.
                ...
                updateHealthWithDifficulty(-5);  // Unsuccessful introspection leads to frustration and stress.
            ...
            setTimeout(() => {
                updateChoices([
            { text: "Continue", action: () => { startOpt1FireChapter9(); playVideo('fireCutscene9.mp4'); } }
                ]);
            }, 300);
            break;
        ...
        case 2:
            ...
            if (skillCheck('wisdom', 15)) {
                updateEnergyWithDifficulty(+5);  // Reaffirming your vow strengthens your resolve and sparks motivation.
                ...
                updateHealthWithDifficulty(-10);  // Doubt creeps in, weakening your resolve and causing distress.
            ...
            setTimeout(() => {
                updateChoices([
            { text: "Continue", action: () => { startOpt2FireChapter9(); playVideo('fireCutscene9.mp4'); } }
                ]);
            }, 300);
            break;
