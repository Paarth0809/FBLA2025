...
function handleOpt2EarthChapter8Choice(choice) {
    switch (choice) {
        case 1:
            ...
            `);
            updateSkillWithDifficulty('leadership', 1); // Improves stealth for infiltration
            updateReputationWithDifficulty('Team Avatar', 1); // Increases reputation with Team Avatar
            break;
        ...
        case 2:
            ...
            `);
            updateSkillWithDifficulty('combat', 2); // Improves strategy for creating diversions
            updateReputationWithDifficulty('Team Avatar', 1); // Increases reputation with Team Avatar
            break;
        ...
        case 3:
            ...
            `);
            updateSkillWithDifficulty('combat', 2); // Improves Metalbending skills
            updateReputationWithDifficulty('Team Avatar', 1); // Increases reputation with Team Avatar
            break;
