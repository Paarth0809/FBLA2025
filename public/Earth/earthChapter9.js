...
function handleOpt1EarthChapter9Choice(choice) {
    switch (choice) {
        case 1:
            ...
            `);
            updateSkillWithDifficulty('wisdom', 2); // Improves Earthbending skills
        ...
        case 4:
            ...
            `);
            updateSkillWithDifficulty('wisdom', 2); // Improves spirituality for connecting with the elements
            updateReputationWithDifficulty('Team Avatar', 1); // Increases reputation with Team Avatar
            break;
    }
