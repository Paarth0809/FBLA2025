...
function displayChapter7() {
    ...
    updateChoices([
        { text: "Reflect on your actions and their consequences", action: () => handleChapter7Choice(1) },
        { text: "Seek guidance from Uncle Iroh", action: () => handleChapter7Choice(2) },
        { text: "Abandon the quest and begin a new journey", action: () => handleChapter7Choice(3) },
        { text: "Confront Azula and seek answers", action: () => handleChapter7Choice(4) }
    ]);
}
