...
export function startAirChapter8() {
  logGameState("Inside startAirChapter8");
  gameState.currentChapter = 8;
  displayAirChapter8();
}

function displayAirChapter8() {
  logGameState("displayAirChapter8");
  const chapter8Text = `
  ...
  switch (choice) {
    ...
    case 2:
      ...
      if (skillCheck('waterbending', 12)) {
        ...
        updateChoices([{ text: "Continue", action: startOp21AirChapter9 }]);
      }
