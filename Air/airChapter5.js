...
function displayOpt2AirChapter5() {
    logGameState("displayOpt2AirChapter5");
    const chapter5Text = `
        <h2>Chapter 5: Omashu and King Bumi</h2>
...
function handleOpt1AirChapter5Choice(choice) {
    switch (choice) {
        ...
        case 2: // Try to convince Bumi
            ...
            if (skillCheck('diplomacy', 16)) {  // Very difficult check
    ...
    setTimeout(() => {
        updateChoices([
            { text: "Continue", action: startOpt1AirChapter6 }
        ]);
    }, 300);
}
...
function handleOpt2AirChapter5Choice(choice) {
    switch (choice) {
        case 1: // Use stealth
            ...
            if (skillCheck('stealth', 14)) {
                ...
                addToInventory(items.omashuMap);
            } else {
                updateHealth(-5);
        ...
        case 3: // Understand deeper meaning
            ...
            if (skillCheck('wisdom', 15)) {
                updateSkill('avatarState', 1);  // This insight helps your spiritual connection
        ...
        case 4: // Bypass trials
            ...
            if (skillCheck('stealth', 16) && skillCheck('airbending', 14)) {  // Very difficult check
    ...
    setTimeout(() => {
        updateChoices([
            { text: "Continue", action: startOpt2AirChapter6 }
        ]);
    }, 300);
}
// Air code end